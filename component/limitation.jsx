    ...
    <div className="limitation-container">
      ...
      <div className="grid">
        <div className="Grid-content">
          <div className="item-1 padding-32">
          ...
          <div className="item-2 padding-32">
            <div className="heading">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
          ...
          <div className="item-3 padding-32">
            <div className="heading">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
          ...
          <div className="item-4 padding-32">
            <div className="heading">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
          ...
          <div className="item-5 padding-32 ">
            <div className="heading">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
